      ...
      <div className="footer-row">
        ...
        <div className="footer-col middle">
          <ul className="footer-menu">
            <li><Link to="/bedrijf/home">Home</Link></li>
            <li><Link to="/bedrijf/studenten">Studenten</Link></li>
            <li><Link to="/bedrijf/reservaties">Reservaties</Link></li>
            <li><Link to="/bedrijf/contact">Contact</Link></li>
          </ul>
        </div>
